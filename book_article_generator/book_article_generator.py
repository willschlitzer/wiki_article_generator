...
nytimes_citation = create_web_citation(
    name=nytimes_name,
    author_last=nytimes_last,
    author_first=nytimes_first,
    work=nytimes_work,
    publisher=nytimes_publisher,
    title=nytimes_title,
    url=nytimes_url,
    date=nytimes_date,
...
kirkus_citation = create_web_citation(
    name=kirkus_name,
    author_last=kirkus_last,
    author_first=kirkus_first,
    work=kirkus_work,
    publisher=kirkus_publisher,
    title=kirkus_title,
    url=kirkus_url,
    date=kirkus_date,
    date_accessed=date_accesssed,
...
pw_citation = create_web_citation(
    name=pw_name,
    author_last=pw_last,
    author_first=pw_first,
    work=pw_work,
    publisher=pw_publisher,
    title=pw_title,
    url=pw_url,
    date=pw_date,
    date_accessed=date_accesssed,
...
misc1_citation = create_web_citation(
    name=misc1_name,
    author_last=misc1_last,
    author_first=misc1_first,
    work=misc1_work,
    publisher=misc1_publisher,
    title=misc1_title,
    url=misc1_url,
    date=misc1_date,
    date_accessed=date_accesssed,
...
misc2_citation = create_web_citation(
    name=misc2_name,
    author_last=misc2_last,
    author_first=misc2_first,
    work=misc2_work,
    publisher=misc2_publisher,
    title=misc2_title,
    url=misc2_url,
    date=misc2_date,
    date_accessed=date_accesssed,
...
# print(infobox_text)
main_text = (
    "'''''" + title + "''''' is a " + publisher_date[-4:] + " book by " + author + "."
)
